          ...
          <div className="about-experience">
            <div className="experience-list">
              <div className="experience-item">
                <span className="exp-date">2023.03 - 현재</span>
                <h3 className="exp-title">한국공학대학교 게임공학과</h3>
                <span className="exp-company">재학중</span>
              </div>
              <div className="experience-item">
                <span className="exp-date">2025.07 - 2025.12</span>
                <h3 className="exp-title">게임 클라이언트 개발 인턴</h3>
                <span className="exp-company">OO게임즈</span>
              </div>
              <div className="experience-item">
                <span className="exp-date">2024.01 - 2024.12</span>
                <h3 className="exp-title">교내 게임 개발 동아리 회장</h3>
                <span className="exp-company">GameMakers</span>
              </div>
            </div>
          </div>
        </div>
